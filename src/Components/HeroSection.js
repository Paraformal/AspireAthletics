  ...
  return (
    <section id='home' className=' w-screen min-h-screen bg-hero-pattern bg-cover bg-fixed bg-left max-sm:bg-center max-lg:bg-center'>
      ...
      className=' min-h-screen max-container font-semibold flex justify-center items-start flex-col padding-x overflow-x-hidden'>
        <p className=' text-[#9D101C] relative before:absolute before:w-20 before:h-1 before:bg-[#9D101C] before:top-[50%] before:left-0 pl-24 text-2xl before:translate-y-[-50%] max-sm:text-xl max-sm:before:w-14 max-sm:pl-20'></p>
        ...
        <button className=' py-4 px-7 text-xl group relative text-white bg-[#9D101C] rounded-sm'>
